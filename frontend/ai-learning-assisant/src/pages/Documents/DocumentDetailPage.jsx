      ...
      <div className="mt-6">
        ...
        {activeTab === 'actions' && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
             ...
             {/* Infographic Generation Card - full width */}
             <div className="card-standard p-6 space-y-5 md:col-span-2">
               <div className="flex items-center justify-between">
                 <div className="flex items-center space-x-3.5">
                   ...
                   <div>
                     <h3 className="text-base font-bold text-zinc-800">Generate Visual Infographic</h3>
                     <p className="text-[10px] font-bold text-violet-500 uppercase tracking-widest mt-px">AI-powered visual knowledge map</p>
                   </div>
                 </div>
                 {existingInfographic && (
                   <button
                     onClick={() => navigate(`/infographics/${existingInfographic._id}`)}
                     className="text-xs font-bold text-violet-500 hover:text-violet-700 transition-colors flex items-center space-x-1"
                   >
                     <BarChart2 size={12} />
               ...
               <p className="text-sm text-zinc-400 leading-relaxed font-medium">
                 Transform this document into a stunning visual infographic with key metrics, concept maps, step-by-step timelines, and high-impact takeaways — all auto-generated by AI.
               </p>
               <button
                 onClick={handleGenerateInfographic}
                 disabled={isGeneratingInfographic}
                 className="w-full bg-gradient-to-r from-violet-500 to-[#ed7e99] hover:opacity-90 disabled:opacity-50 text-white font-bold py-3 rounded-xl transition-all flex items-center justify-center space-x-2 active:scale-[0.98] shadow-md shadow-violet-200"
               >
                 {isGeneratingInfographic ? (
                   <><Loader2 size={16} className="animate-spin" /><span>Generating Infographic...</span></>
                 ) : (
                   <><BarChart2 size={16} /><span>Generate Visual Infographic</span></>
                 )}
               </button>
             </div>
           </div>
